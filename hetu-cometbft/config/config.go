...
type Config struct {
	...
	Narwhal         *NarwhalConfig         `mapstructure:"narwhal"`
}
...
func DefaultNarwhalConfig() *NarwhalConfig {
	return &NarwhalConfig{"127.0.0.1"}
}
...
func (cfg *MempoolConfig) ValidateBasic() error {
	switch cfg.Type {
	case MempoolTypeFlood, MempoolTypeNop, MempoolTypeNarwhal:
